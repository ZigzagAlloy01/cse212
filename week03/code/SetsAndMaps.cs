...
public static class SetsAndMaps
{
    ...
    public static bool IsAnagram(string word1, string word2)
    {
        ...
        string cleanWord1 = new string(word1.ToLower().Where(char.IsLetterOrDigit).ToArray());
        string cleanWord2 = new string(word2.ToLower().Where(char.IsLetterOrDigit).ToArray());
